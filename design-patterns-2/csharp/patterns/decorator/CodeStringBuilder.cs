...
/// <summary>
/// Decorator for StringBuilder.
/// It is a dummy example it decorate only few methods, 
/// since the StringBuilder has a ton of them
/// 
/// This shows that if the class to decorate has a lot of methods it is not the best idea to decorate it
/// </summary>
public class CodeBuilder
{
    ...
    /// <summary>
    /// This is the only one method we want to change
    /// </summary>
    ...
    {
        return "Decorated method " + builder.ToString(startIndex, length);
    }
