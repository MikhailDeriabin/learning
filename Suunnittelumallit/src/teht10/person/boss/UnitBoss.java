...
public class UnitBoss extends Person implements Boss{
    private Boss nextBoss;

    public UnitBoss(String name, float salary, Boss nextBoss) {
        super(name, PersonType.UNIT_BOSS, salary);
    ...
    public void riseSalary(Application application) {
        ...
        boolean isAbleToRise = riseAmount >= applicationPerson.getSalary()*0.02 && riseAmount < applicationPerson.getSalary()*0.05;
        if(isAbleToRise){
