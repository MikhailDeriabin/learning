...
public class Main {
    public static void main(String[] args) {
        ...
        MaxBinaryHeapArray heap1 = generateRandNumMaxHeap(elemCount, minValue, maxValue);

        int[] unsortedHeap1 = heap1.getNodes();

        System.out.println("-------------- Heap1 --------------");
        printArray(unsortedHeap1);

        int[] sortedHeap1 = heap1.sort();
        System.out.println("-------------- After heap1 sort --------------");
        printArray(sortedHeap1);
    ...
    public static MaxBinaryHeapArray generateRandNumMaxHeap(int elemCount, int minValue, int maxValue){
        MaxBinaryHeapArray heap = new MaxBinaryHeapArray(elemCount);
