...
//Notice the (content) and (marketing), this folder creates a route group. 
//It does not add anything to the url. But we can add different layout files for different groups
